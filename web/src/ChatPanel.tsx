...
type ChatPanelProps = { mode: 'embedded' | 'floating' | 'minimized'; authenticated: boolean; onMinimize: () => void; onRestore: () => void; onTogglePlacement: () => void }

export function ChatPanel({ mode, authenticated, onMinimize, onRestore, onTogglePlacement }: ChatPanelProps) {
